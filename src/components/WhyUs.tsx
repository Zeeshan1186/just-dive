    ...
    return (
        <>
            ...
            <section className="mt-6">
                ...
                {/* Team Grid */}
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 pb-10 px-4 sm:px-8">

                    {/* Team Member 0 */}
                    <div
                        className="relative flex flex-col justify-end items-start text-white p-4 
               bg-cover bg-center sm:w-[80%] w-full h-[60vh] rounded-lg overflow-hidden
               ...
               bg-cover bg-center sm:w-[80%] w-full h-[60vh] rounded-lg overflow-hidden
               transform transition-all duration-500 ease-in-out
               hover:scale-105 hover:shadow-2xl" style={{ backgroundImage: `url(${director})` }}>
                        <div className="absolute inset-0 bg-black/20"></div>
                        <div className="relative z-10">
                            <h3 className="text-lg font-semibold">Mr. Girish Pillai</h3>
