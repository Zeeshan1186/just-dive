        ...
        <section className="flex flex-col md:flex-row items-center gap-10 px-6 py-12 max-w-7xl mx-auto">
            ...
            <div className="w-full md:w-[50%] text-center md:text-left">
                ...
                <div className="flex flex-col items-center sm:flex-row justify-around text-center gap-6 sm:gap-0">
                    <div>
                        <Link to={`/aboutus`}>
                            <Button className="w-36 text-white  cursor-pointer font-normal bg-[#0191e9] hover:text-[#0191e9] transition hover:bg-transparent hover:border-1 border-[#0191e9] rounded-full text-sm px-4 py-2">
                                Read More About Us
                            </Button>
                        </Link>
                    </div>
