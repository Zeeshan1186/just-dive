            ...
            <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-[35%_1fr_1fr_1fr] gap-8 text-left">
                ...
                <div className="col-span-2 md:col-span-1 flex flex-col items-start">
                    ...
                    <div className="flex space-x-3">
                        <Link to="https://www.instagram.com/justdive_murdeshwar" target="_blank" className="p-1 bg-white text-[#0191e9] hover:bg-[#0191e9] hover:text-white rounded-md" aria-label="Instagram - Just Dive Scuba Murdeshwar">
                            <Instagram size={20} />
                        </Link>
                        <Link to="https://www.facebook.com/JustDiveScubaMurdeshwar/" target="_blank" className="p-1 bg-white text-[#0191e9] hover:bg-[#0191e9] hover:text-white rounded-md" aria-label="Facebook - Just Dive Scuba Murdeshwar">
                            <Facebook size={20} />
                        </Link>
                    </div>
                </div>
