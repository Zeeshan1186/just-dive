        ...
        <div>
            ...
            <div className="w-full flex flex-col py-30 Trirong font-normal items-center justify-center gap-6">
                <div className="flex justify-center ">
                    <Button className="animate-pulse text-white font-normal Poppins bg-[#b89d53] hover:text-[#b89d53] hover:bg-transparent hover:border-1 border-[#b89d53] rounded-full text-sm px-6 py-2">
                        Check Availability
                    </Button>
                </div>
                <div className="bg-gray-100 rounded-xl shadow-md py-6 px-8 text-center w-full">
                    ...
                    <Button className="animate-pulse text-white Poppins font-normal bg-[#b89d53] hover:text-[#b89d53] hover:bg-transparent hover:border-1 border-[#b89d53] rounded-full text-sm px-4 py-2">
                        Book Now
                    </Button>
                </div>
