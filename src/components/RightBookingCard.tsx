        ...
        <div>
            ...
            <div className="w-full flex flex-col py-30 Trirong font-normal items-center justify-center gap-6">
                ...
                <div className="bg-gray-100 rounded-xl shadow-md py-6 px-8 text-center w-full">
                    ...
                    <Link to={`/booking`}>
                        <Button className="animate-pulse cursor-pointer text-white Poppins font-normal bg-[#0191e9] hover:text-[#0191e9] hover:bg-transparent hover:border-1 border-[#0191e9] rounded-full text-sm px-4 py-2">
                            Book Now
                        </Button>
                    </Link>
                </div>
